...
mesh = jax.make_mesh((1, 2), ('x', 'reduce'))
...
matrix1 = jax.random.normal(key1, (8191, 8192), dtype=jnp.float32).block_until_ready()
matrix2 = jax.random.normal(key2, (8192, 8190), dtype=jnp.float32).block_until_ready()
